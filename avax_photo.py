...
def plot_graph_for_column(column, index):
    ...
    ax.set_title(f"Address Relationship for avax_group{index} with Shell Layout", fontsize=16, pad=20)

    output_path = os.path.join(output_directory, f"avax_group{index}.png")
