...
groups_df = pd.read_csv(r"C:\optimism_large_connected_groups.csv")
...
for index, group in enumerate(groups, start=1):
    ...
    for address in addresses:
        transactions = get_transactions_optimism(address, API_KEYS_OPTIMISM[0])
...
# save
output_file_path = r"C:\optimism_token_transfers_per_group.csv"
