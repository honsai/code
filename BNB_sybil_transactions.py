...
groups_df = pd.read_csv(r"C:\BNB_large_connected_groups.csv")
...
for index, group in enumerate(groups, start=1):
    ...
    for address in addresses:
        transactions = get_transactions_bsc(address, API_KEYS_BSC[0])
...
# save
output_file_path = r"C:\BNB_token_transfers_per_group.csv"
